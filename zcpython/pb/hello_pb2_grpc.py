...
class HelloServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sayWll = channel.unary_unary(
                '/HelloService/sayWll',
                request_serializer=hello__pb2.HelloRequest.SerializeToString,
...
class HelloServiceServicer(object):
    ...
    def sayWll(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_HelloServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'sayWll': grpc.unary_unary_rpc_method_handler(
                    servicer.sayWll,
                    request_deserializer=hello__pb2.HelloRequest.FromString,
...
class HelloService(object):
    ...
    def sayWll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/HelloService/sayWll',
            hello__pb2.HelloRequest.SerializeToString,
            hello__pb2.HelloRequest.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
